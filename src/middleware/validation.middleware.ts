...
export const validateMovieCreate = [
  ...
  body('genres').optional().isLength({ max: 500 }).withMessage('Genres must be less than 500 characters'),
  body('quality').optional().isIn(['480p', '720p', '1080p', '2160p', '3D']).withMessage('Quality must be one of: 480p, 720p, 1080p, 2160p, 3D'),
  ...
  body('director').optional().isLength({ max: 255 }).withMessage('Director must be less than 255 characters'),
